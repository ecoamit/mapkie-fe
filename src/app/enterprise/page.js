...
export default function EnterprisePage() {
  return (
    ...
    >
      ...
      <div className="md:hidden w-full flex flex-col md:pt-24 md:px-6 gap-8">
        <div>
          <HeroSection
            showTabs={false}
      ...
      <div className="relative h-[100vh] max-h-[100vh] flex flex-col hidden md:flex">
        {/* Hero Section with only text content */}
        <div
          className="relative z-10 flex-1 flex items-start pt-20"
