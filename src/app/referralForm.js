...
export default function ReferralForm() {
  ...
  return (
    <section
      className="relative isolate w-full min-h-[calc(100svh-80px)] overflow-hidden bg-[linear-gradient(to_bottom,#E8F0F3_0%,#E8F0F3_56%,#ffffff_56%,#ffffff_100%)]"
    >
      {/* Background dotted rectangles */}
      ...
      <div className="relative mx-auto max-w-[1120px] px-4 sm:px-6 lg:px-8 py-8 md:py-10 lg:py-12 min-h-[calc(100svh-80px)] flex flex-col items-center justify-center">
        {submitted ? (
          <div className="relative w-full max-w-2xl">
            {/* Center dotted rectangle behind card */}
            ...
            {/* Bottom dotted rectangle for depth */}
        ...
        <div className="text-center max-w-3xl mx-auto">
          <h2 className="text-[28px] sm:text-[32px] md:text-[36px] lg:text-[40px] leading-tight font-semibold text-[#0D2A3F]">
            Looking for a Referral? Our Team Will
            <br className="hidden sm:block" /> Reach Out Soon!
          </h2>
          <p className="mt-4 text-[14px] sm:text-[15px] md:text-[16px] text-[#496276] leading-relaxed">
            Increase your chances of landing interviews through trusted employee referrals. Share
            your profile and we’ll help connect you with the right opportunities.
          </p>
        </div>
        ...
        <div className="mt-6 md:mt-8 lg:mt-10 mx-auto max-w-3xl w-full">
          ...
          >
            <div>
              <h3 className="text-[18px] md:text-[20px] font-semibold text-[#0D2A3F]">
                Referral Program Form
              </h3>
              <p className="mt-1 text-[12px] md:text-[13px] text-[#5C7285]">
                Fill in the details below, our team will reach out to help you get started!
              </p>
            </div>
            ...
            <div className="mt-5">
              ...
              <input
                ...
                className="w-full h-11 rounded-md border border-[#D5E2EA] px-3.5 text-[14px] placeholder:text-[#9CB0BD] focus:outline-none focus:ring-2 focus:ring-[#1D6C86]/30 focus:border-[#1D6C86]"
              />
            </div>
            ...
            <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <label htmlFor="phone" className="block text-[12px] text-[#39586A] mb-1.5">Phone number</label>
                <input
                  type="tel"
                  id="phone"
            ...
            <div className="mt-4">
              ...
              <input
                type="text"
                id="position"
                placeholder="Specify the job title or role"
                className="w-full h-11 rounded-md border border-[#D5E2EA] px-3.5 text-[14px] placeholder:text-[#9CB0BD] focus:outline-none focus:ring-2 focus:ring-[#1D6C86]/30 focus:border-[#1D6C86]"
              />
            </div>
            ...
            <div className="mt-4">
              ...
              <div className="flex items-center gap-3">
                <label htmlFor="resume" className="flex-1 group cursor-pointer" aria-label="Upload resume">
                  ...
                  <div className="flex items-center gap-3 h-[54px] rounded-md border border-dashed border-[#C8D7E0] px-4">
                    ...
                    <div className="flex-1">
                      <p className="text-[13px] text-[#577287] leading-tight">
                ...
                <button
                  type="button"
                  className="shrink-0 h-[48px] px-6 rounded-full text-[14px] font-medium focus:outline-none"
                  style={{
            ...
            <p className="mt-5 text-[11px] text-[#6C8494]">
              By clicking Submit below you confirm that you have read and agree to
              {" "}
              <span className="text-[#1D6C86] underline">Mapkie Privacy Policy</span>
            </p>
            ...
            <div className="mt-6">
              <button
                type="submit"
                className="w-full h-[52px] md:h-[54px] rounded-full text-white text-[14px] font-medium"
                style={{
                  background:
                    "linear-gradient(99.23deg, #006C86 0%, #061F34 114.48%)",
                  boxShadow: "0 6px 18px rgba(0,0,0,0.10)",
                }}
              >
                Submit
