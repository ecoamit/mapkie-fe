...
export default function HeroSection() {
  ...
  return (
    <section
      className="relative w-full min-h-[calc(100svh-80px)] md:min-h-[75vh] lg:min-h-[80vh] xl:min-h-[85vh] 2xl:min-h-[850px] max-h-screen bg-[#E8F0F3] overflow-hidden flex items-center py-6 md:py-8 xl:py-10 2xl:py-12 pl-4 md:pl-6 xl:pl-10 pr-0 md:pt-0"
    >
