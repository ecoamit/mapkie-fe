            ...
            <div className="relative bg-white rounded-2xl shadow-[0_14px_40px_rgba(6,31,52,0.10)] border border-[#E0E8ED] px-5 sm:px-6 md:px-7 lg:px-10 py-6 md:py-8 w-full max-w-[540px]">
              {submitted ? (
                ...
                <form onSubmit={onSubmit} className="space-y-4">
                  ...
                  <div className="pt-1">
                    <button type="submit" disabled={submitting} className="w-full h-[52px] md:h-[54px] rounded-full text-white text-[14px] font-medium disabled:opacity-70 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#1D6C86]" style={{ background: 'linear-gradient(99.23deg, #006C86 0%, #061F34 114.48%)', boxShadow: '0 6px 18px rgba(0,0,0,0.10)' }}>{submitting ? 'Submitting...' : 'Submit'}</button>
                  </div>
                </form>
              )}
            </div>
  ...
  <div className="mt-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-7 xl:gap-10 px-1">
          <div className="bg-white rounded-xl border border-[#E6ECF0] shadow-[0_6px_18px_rgba(6,31,52,0.08)] p-6 flex flex-col items-center text-center">
            <div className="w-12 h-12 rounded-full bg-[#0D5F78] flex items-center justify-center shadow-sm mb-4">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#ffffff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6A19.79 19.79 0 0 1 2.08 4.18 2 2 0 0 1 4 2h3a2 2 0 0 1 2 1.72c.12.9.33 1.78.63 2.63a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.45-1.09a2 2 0 0 1 2.11-.45c.85.3 1.73.51 2.63.63A2 2 0 0 1 22 16.92z"/></svg>
            </div>
            <p className="text-[#496276] text-[12px] uppercase tracking-wide font-medium">Phone Number</p>
            <p className="mt-1 text-[#0D2A3F] text-[15px] font-semibold">+9563258740</p>
          </div>
          <div className="bg-white rounded-xl border border-[#E6ECF0] shadow-[0_6px_18px_rgba(6,31,52,0.08)] p-6 flex flex-col items-center text-center">
            <div className="w-12 h-12 rounded-full bg-[#0D5F78] flex items-center justify-center shadow-sm mb-4">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#ffffff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7z"/><circle cx="12" cy="9" r="2.5"/></svg>
            </div>
            <p className="text-[#496276] text-[12px] uppercase tracking-wide font-medium">Location</p>
            <p className="mt-1 text-[#0D2A3F] text-[15px] font-semibold leading-snug">Theatre Royal, Catherine Street<br/> ,Drury Lane</p>
          </div>
          <div className="bg-white rounded-xl border border-[#E6ECF0] shadow-[0_6px_18px_rgba(6,31,52,0.08)] p-6 flex flex-col items-center text-center">
            <div className="w-12 h-12 rounded-full bg-[#0D5F78] flex items-center justify-center shadow-sm mb-4">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#ffffff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4h16a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2z"/><path d="m22 6-10 7L2 6"/></svg>
            </div>
            <p className="text-[#496276] text-[12px] uppercase tracking-wide font-medium">Email</p>
            <p className="mt-1 text-[#0D2A3F] text-[15px] font-semibold">support@mapkie.com</p>
          </div>
        </div>
      </div>
    </section>
